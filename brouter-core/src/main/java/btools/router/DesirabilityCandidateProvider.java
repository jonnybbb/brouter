 ...
 * cell key -&gt; {@code [nodeCount, prefWeightedSum]}, where {@code prefWeighted}
 * rewards nodes reached cheaply per air-meter, i.e. on profile-preferred roads).
...
public class DesirabilityCandidateProvider implements RoundTripCandidateProvider {
  ...
  /**
   * @param grid     the accumulated desirability grid (cell key -&gt; [nodeCount, prefWeightedSum])
